...
## Project Structure
    ...
    ├── testapiautostorybo_102366  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_102366`
...
2. Clone this repo and `cd testapiautostorybo_102366`
